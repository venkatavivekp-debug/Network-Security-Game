...
ALTER TABLE puzzles ADD COLUMN IF NOT EXISTS recovered_key LONGTEXT NULL;
ALTER TABLE puzzles ADD COLUMN IF NOT EXISTS solved_answer_hash VARCHAR(64) NULL;
